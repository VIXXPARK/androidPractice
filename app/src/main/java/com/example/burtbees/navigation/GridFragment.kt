...
class GridFragment:Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        fragmentView?.findViewById<RecyclerView>(R.id.gridfragment_recylerview)?.adapter=UserFragmentRecyclerViewAdapter()
        fragmentView?.findViewById<RecyclerView>(R.id.gridfragment_recylerview)?.layoutManager=GridLayoutManager(activity,3)
        return fragmentView
    }
